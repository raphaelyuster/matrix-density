...
S = "emptyset"  # S could be "emptyset" or "monotone". Current dir must contain files <S>.dat-s and <S>.out
...
print(M,"-", "Rounded SDP result + epsilon:", M, "-", int(res-inf_norm), "/", D*D, "=", M- (res-inf_norm)/(D*D))
print("Final result divided by M="+str(M)+":", str(1-(res-inf_norm)/(D*D*M))[0:9]+"...")
